...
public class WorkspaceManager {
    ...
    public void createSnapshot(String workspaceId) throws NotFoundException, ServerException, ConflictException {
        ...
        checkWorkspaceIsRunning(workspace, format("Could not create a snapshot of the workspace '%s:%s' because its status is '%s'.",
    ...
    void performAsyncStop(WorkspaceImpl workspace) throws ConflictException {
        checkWorkspaceIsRunning(workspace, format("Could not stop the workspace '%s:%s' because its status is '%s'.",
                                                  workspace.getNamespace(),
                                                  workspace.getConfig().getName(),
                                                  workspace.getStatus()));
    ...
    private void checkWorkspaceIsRunning(WorkspaceImpl workspace, String msg) throws ConflictException {
